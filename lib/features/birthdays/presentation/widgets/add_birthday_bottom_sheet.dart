...
class AddBirthdayBottomSheet extends StatefulWidget {
  const AddBirthdayBottomSheet({super.key});

  @override
  State<AddBirthdayBottomSheet> createState() => _AddBirthdayBottomSheetState();
}

class _AddBirthdayBottomSheetState extends State<AddBirthdayBottomSheet> {
            ...
            children: [
              ...
              InkWell(
                onTap: () {
                  ...
                  context.read<BirthdaysBloc>().add(AddBirthday(birthday));
                  context.pop();
                },
                child: Container(
